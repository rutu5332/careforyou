...
public class AddDoc extends HttpServlet
{
			...
			throws ServletException, IOException
	{
		...
		//	String sql_up="update doctorinfo_tbl SET vFirstName='"+fname+"',vLastName='"+lname+"',vGender='"+gen+"',vClinicAdd='"+address+"',vMobile='"+mno+"',vPassword='"+psw+"',vEmail='"+email+"',vFileName='"+filename+"',dBirthdate='"+bday2+"',vLicense='"+filename2+"',vDegree='"+deg+"',iExperience='"+exp+"',iWorkType='"+type+"' WHERE iDoctorId='"+uid+"' ";
			String insert="insert into doctorinfo_tbl(vFirstName,vLastName,vGender,vClinicAdd,vMobile,vPassword,vEmail,vFileName,dBirthdate,vLicense,vDegree,iExperience,iWorkType) values('"+fname+"','"+lname+"','"+gen+"','"+address+"','"+mno+"','"+psw+"','"+email+"','"+filename+"','"+bday+"','"+filename2+"','"+deg+"','"+exp+"','"+type+"')";
