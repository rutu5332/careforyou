        ...
        <ul class="nav">
          ...
          else
          {
        	 %> <li class="nav-item "><%
        	  ...
        	  %>
            <a class="nav-link" href="AdminData.jsp">
             <!--  <i class="material-icons">date_range</i> -->
              <p> Admin data </p>
            </a>
          </li>
          ...
          else
          {
        	 %> <li class="nav-item "><%
        	  ...
        	  %>
            <a class="nav-link" href="RegData.jsp">
             <!--  <i class="material-icons">date_range</i> -->
          ...
          else
          {
        	 %> <li class="nav-item "><%
        	  ...
        	  %>
            <a class="nav-link" href="ProductData.jsp">
             <!--  <i class="material-icons">date_range</i> -->
              <p> Product data </p>
            </a>
          </li>
          ...
          else
          {
        	 %> <li class="nav-item "><%
        	  ...
        	  %>
            <a class="nav-link" href="DoctorData.jsp">
             <!--  <i class="material-icons">date_range</i> -->
              <p> Doctor data </p>
            </a>
          </li>
          ...
          else
          {
        	 %> <li class="nav-item "><%
        	  ...
        	  %>
            <a class="nav-link" href="DocAppointments.jsp">
             <!--  <i class="material-icons">date_range</i> -->
          ...
          else
          {
        	 %> <li class="nav-item "><%
        	  ...
        	  %>
            <a class="nav-link" href="LabData.jsp">
             <!--  <i class="material-icons">date_range</i> -->
              <p> Laboratory data </p>
            </a>
          </li>
          ...
          else
          {
        	 %> <li class="nav-item "><%
        	  ...
        	  %>
            <a class="nav-link" href="PhleboData.jsp">
             <!--  <i class="material-icons">date_range</i> -->
          ...
          else
          {
        	 %> <li class="nav-item "><%
        	  ...
        	  %>
            <a class="nav-link" href="PatientData.jsp">
             <!--  <i class="material-icons">date_range</i> -->
              <p> Patient data </p>
            </a>
          </li>
          ...
          else
          {
            ...
            <a class="nav-link" href="Contactdata.jsp">
             <!--  <i class="material-icons">date_range</i> -->
              <p> ContactUs data </p>
            </a>
          </li>
          ...
          else
          {
        	 %> <li class="nav-item "><%
        	  ...
        	  %>
            <a class="nav-link" href="FeedbackData.jsp">
             <!--  <i class="material-icons">date_range</i> -->
              <p> Feedback data </p>
            </a>
          </li>
          
           <% if(name.equals("Notification.jsp"))
          {
        	%>  <li class="nav-item active"><% 
          }
          else
