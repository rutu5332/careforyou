...
<%
	    ...
	    String fnm="",lnm="",add="",phno="",age="",time="",gender="",email="",diseases="",docid,date,com;
		String id,sub,txt;
		String dname,demail="";
		String uemail="",uid="";
		String fees="";
		...
		try
		{
			...
			String insert="insert into patient_tbl(vFname,vLname,vAddress,vPhoneNo,iAge,vGender,vEmail) values('" + fnm + "','" + lnm + "','"+add+"'," + phno + "," + age + ",'" + gender + "','" + email + "')";
