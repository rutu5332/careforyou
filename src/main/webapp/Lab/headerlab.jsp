...
<body>
   ...
   <%
		...
		String select="select * from notification_tbl where vNotificationTo like 'lab' && eStatus='A' && iId="+lid +" order by iNotificationId desc" ;
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbar-menu">
                   <ul class="nav navbar-nav navbar-right" data-in="#" data-out="#">
                         ...
                         <%
	                        dt.st=dt.cn.createStatement();
                 			String sql_menu = "select * from menulab_tbl";
