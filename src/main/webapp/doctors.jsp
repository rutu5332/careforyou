            ...
            <div class="row">
                <div class="product-items text-center">
            		...
            		String depnames[]={"","Primary Care","cardiologist","dermatologist","pediatrician","neurologist",
                		...
                		{
                			String link="doctor.jsp?id="+i;
                			out.println("<a href=\""+ link +"\">");
                    		out.println("<div class=\"col-md-4 col-sm-6 equal-height\">");      
                    		out.println(" <div class=\"item\">");
                    		out.println(" <div class=\"thumb\" >");
                    		out.println("<img style=\"height:200px;width:300px;\" src=\"assets/img/departments/department"+i +".jpg\" alt=\"Thumb\">");
                    		out.println("</div>");
                    		 out.println("<div class=\"info\">");
                    		out.println("<h4> "+depnames[i]+"</h4>");
                    		out.println("</div>"); 
                    		out.println("</div>");
                    		out.println("</div>");
                    		out.println("</a>");
