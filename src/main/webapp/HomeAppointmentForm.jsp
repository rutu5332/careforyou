...
<head>
    ...
    <!-- ========== Page Title ========== -->
    <title>Home Visit Appointment Form</title>
            ...
            <div class="row">
                <div class="col-md-6 appoinment">
                    <div class="appoinment-box">
                        ...
                        <form action="HomeAppointment.jsp" method="post" >
                        ...
                        <form action="HomeAppointmentSubmit.jsp" method="post" name="homeApp" id="homeApp">
                        	<input type="hidden" name="docid" value="<%out.println(id);%>" >
                        	<input type="hidden" name="date" value="<%out.println(dt);%>" >
                        	<input type="hidden" name="fees" value="<%out.println(fees);%>" >
                            <div class="row">
                              ...
                              <div class="row">
                                <div class="col-md-12">
                                    <button type="submit" name="homesub" id="homesub">
...
<script src="assets/js/HomeAppointmentjs.js"></script>
</html>