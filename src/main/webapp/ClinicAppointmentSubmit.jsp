...
<%
		...
		fnm=request.getParameter("fname").trim();
		lnm=request.getParameter("lname").trim();
		phno=request.getParameter("phone").trim();
		...
		try
		{
			...
			String insert="insert into patient_tbl(vFname,vLname,vPhoneNo,iAge,vGender,vEmail) values('" + fnm + "','" + lnm + "'," + phno + "," + age + ",'" + gender + "','" + email + "')";
