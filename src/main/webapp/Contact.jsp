...
<body>
    ...
    <!-- Start Breadcrumb 
    ============================================= -->
    <div class="breadcrumb-area shadow dark bg-fixed text-light" style="background-image: url(assets/img/banner/13.jpg);">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <h1>Contact Us</h1>
                ...
                <div class="item-box">
                    ...
                    <div class="col-md-4 single-item">
                        <div class="item">
                            ...
                            <h4>Email</h4>
                            <p>
                               <a style="text-transform:none;" href="mailto:care4you2019@gmail.com">
                               care4you2019@gmail.com</a><br>
                               <a style="text-transform:none;" href="mailto:admin@yourdomian.com">
                            ...
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="form-group comments">
                                        ...
                                        <span class="alert-error" id="errorcomm"></span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-12">
