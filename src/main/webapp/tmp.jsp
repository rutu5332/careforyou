...
<body>
            ...
            <div class="row">
                <div class="col-md-8 address-info text-left">
                    <div class="info box">
                        <ul>
                            <li>
                                <a href="mailto:care4you2019@gmail.com"><i class="fas fa-envelope-open"></i> 
                                care4you2019@gmail.com</a>
                            </li>
                            <li>
                ...
                <%
                    		...
                    		String link,btn,usr="",id="",qty="",wlist="",count="";
                    		int total=0;
                    		...
                    		else
                    		{
                    			...
                    			while(dt.rs.next())
                    			{
                    				...
                    				count=dt.rs.getString("vProducts");
   ...
   <!--  <header id="home">
                ...
                <div class="row">
                    <div class="top-search">
                        <div class="input-group">
                            <form action="#">
                                <input type="text" name="text" id="search" class="form-control" placeholder="Search">
                                <button type="submit">
                                    <i class="fas fa-search"></i>
                                </button>  
                            </form>
                            <div class="suggestion">gelrijgie</div>  
                        </div>
                    </div>
                </div>
            </div>
       ...
       <%
    	String names="",ids="",deg="";
	    String sel="select * from product_tbl"; 
	    dt.st=dt.cn.createStatement();
		dt.rs=dt.st.executeQuery(sel);
		while(dt.rs.next())
		{
			ids +=dt.rs.getString("iProductId") + "/";
			names +=dt.rs.getString("vProductName") + "/";
			//deg+=dt.rs.getString("vDegree") + "/";
		}
		/* sel="select * from doctorinfo_tbl"; 
		dt.rs=dt.st.executeQuery(sel);
		while(dt.rs.next())
		{
			deg+=dt.rs.getString("vDegree") + "/";
		} */
		String catname="/Baby care/Joint Pain/Cold and Fever/Diabetes care/Oral care/weight care/covid-19/Personal care/Women Care";
		String depname="/Primary Care/cardiologist/dermatologist/pediatrician/neurologist/psychiatrist/gynecologist/";
		depname+="urologist/radiologist/orthopedist/immunologist";
    %>
        ...
        <nav class="navbar navbar-default attr-border navbar-sticky bootsnav">
            ...
            <div class="container">
                <div class="row">
                    <div class="top-search">
                        <div class="input-group">
                        		<input type="hidden" id="name" value="<%out.println(names); %>">
                        		<input type="hidden" id="id" value="<%out.println(ids); %>">
                        		<input type="hidden" id="cat" value="<%out.println(catname); %>">
                        		<input type="hidden" id="degree" value="<%out.println(depname); %>">
                        		<form action="#">
				...
				<div class="attr-nav">
					<ul>
						<li class="dropdown active">
							<label class="cart-count"><%out.println(total);%></label>
							<a href="#" class="dropdown-toggle" data-toggle="dropdown">
							<i class="fas fa-shopping-cart" style="position:relative;top:-25px;">
							</i>
							</a>
									...
									else
									{
										...
										try{
											...
											for(int i=0;i<citems.length ; i++)
											{
												...
												out.println("<div class=\"col-md-4\"><a href=\"Product.jsp?id="+citems[i]+"\">");
												out.println("<img style=\"height:60px;width:100%;\" src=\"assets/img/products/"+img+"\" alt=\"Thumb\"></a></div>");
												out.println("<div class=\"col-md-4\" style=\"overflow:hidden;\">"+name+" <br>"+price+"</div>");
								...
								%>
									<li>
										<div class="col-md-12 btn btn-theme text-right" style="border:1px solid black;">
										  <a href="Cart.jsp">view cart </a></div>
						...
						<li class="dropdown active"><a href="#" class="dropdown-toggle" data-toggle="dropdown">
							...
							<ul class="dropdown-menu">
										...
										try{
											...
											for(int i=0;i<witems.length ; i++)
											{
												...
												String select = "select * from product_tbl where iProductId="+witems[i];
							         		 	...
							         		 	out.println("<li class=\"drpdwn-itm\"><div class=\"row\">");
												out.println("<div class=\"col-md-4\"><a href=\"Product.jsp?id="+witems[i]+"\">");
												out.println("<img style=\"height:60px;width:100%;\" src=\"assets/img/products/"+img+"\" alt=\"Thumb\"></div>");
												out.println("<div class=\"col-md-6\" style=\"overflow:hidden;\">"+name+"<br>"+price+"</div>");
								...
								%>
									<li>
										<div class="col-md-12 btn btn-theme text-right" style="border:1px solid black;">
										<a href="Wishlist.jsp">view wishlist </a></div>
									 </li>
								</ul>
						</li>
						<%
						...
						{
							dt.st=dt.cn.createStatement();
							String select="select * from notification_tbl where vNotificationTo like 'user' && eStatus='A' && iId="+id +" order by iNotificationId desc" ;
							dt.rs=dt.st.executeQuery(select);
						...
						%>
						<li ><a href="Notification.jsp"><i class="fa fa-bell">
						<% if(cnt >0)
						{ 
							out.println("<label class=\"cart-count\" style=\"left:-5px;top:-10px;font-weight:bolder;\">"+cnt+"</label>");
						 } %>
						</i></a></li>
		    ...
		    <div id="popup1" class="overlay">
				<div class="popup">
					...
					<div class="content">
						<ul  data-in="#" data-out="#" style="text-align:center;font-size:17px;" >
								<li style="padding:10px 0px 10px 0px;background:white;border-bottom:1px solid black;"><a href="Login.jsp" > As User </a></li>
								<li style="padding:10px 0px 10px 0px;background:white;border-bottom:1px solid black;"><a href="LoginDoctor.jsp"> As Doctor </a></li>
								<!-- <li><a href="LoginLab.jsp"> As Lab </a></li>
    ...
    <!-- -------------Email -->  
    <%-- <%
    	String msg,sub,lnk="localhost:8080/careforyou/";
    	sub="Welcome name";
    	msg="<div><center><div style=\"border:1px solid black;height:70%;width:95%;text-align:center;\"><br>";
		msg+="<label style=\"font-family:Copperplate Gothic Bold;color:white;font-size:70px;\">";
		msg+="localhost:8080/<label style=\"color:#0cb8b6;\">careforyou</label>/index.jsp</label>";
		msg+="<br><br><hr>";
		msg+="<div style=\"background-color:teal;height:90%;width:100%;padding-top:10px;\"> <center>";
		msg+="<div style=\"background-color:white;height:40%;width:75%;box-shadow:black;\"><br><br>";
		msg+="<label style=\"font-family:Lucida Handwriting;font-size:45px;\">Welcome to the World of</label><br>";
		msg+="<label style=\"font-size:80px;font-family:Algerian;color:#0cb8b6;\">care for you</label><br><br>";
		msg+="<h2>let the care for your self and your loved ones' begin!</h2></div></center><hr>";
		msg+="</div><h1 style=\"font-family:Lucida Handwriting;font-size:43px;color:blue;\">Thank you ...!!!</h1>";
		msg+="For any query or concern  mail us at care4you2019@gmail.com </div></center></div>";
		try{
			Mail m=new Mail("rutuchudasama.2000@gmail.com",sub,msg);
		}
		catch(Exception e)
		{System.out.println(e);}
		%>  --%> 
